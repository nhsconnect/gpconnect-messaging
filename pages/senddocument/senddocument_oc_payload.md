...
Please refer to [Send Document - Payload structure](senddocument_payload) for a definition of the payload structure to be used to fulfil the [Send Consultation Report](/senddocument_oc_overview.html#federated-appointments-use-case) use case.
