...
PDF changes here...
 - Why does the telephone no come before the address?
 - The term "registered address" can be misinterpreted - can we use Home Address?
 - Page one, Box 2 - Date should be below the other details in this box
 - Box 2 - "change date seen" to "Date of consultation"
 - Box 2 " Date consultation sent" to "Date of letter"
 - Box 2 - Can it be made explicit that the surgery tel No and address are the place that the consultation took place
 - Box 2 - Place of consultation - should be the full address
 - All of it - branding on the doc is in the wrong shade of blue 
